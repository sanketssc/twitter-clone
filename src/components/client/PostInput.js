...
const PostInput = () => {
  ...
  const postTweet = async () => {
    ...
    const res = await fetch("/api/create", {
      method: "post",
      body: JSON.stringify({ content: test, imageUrl: url }),
    });
  ...
  return (
    <div className="mx-auto px-5">
      <div
        className="whitespace-pre-wrap text-xl px-1 py-5 font-semibold focus:outline-none cursor-text border-b border-gray-600 border-dashed"
        // ref={post}
        contentEditable
        id="editable"
